...
Shows the capabilities of the C-like language compiler
"""
...
def demonstrate_compiler_features():
    ...
    for i, example in enumerate(examples, 1):
        ...
        try:
            ...
            print("   " + "-" * 40)for j, line in enumerate(lines[:10], 1):
        ...
        print("   Compiling...")
        try:
            output_file = f"output/{Path(example['file']).stem}.asm"
            ...
            if success:
                ...
                if os.path.exists(output_file):                    size = os.path.getsize(output_file)
    ...
    print()
      if compiled_count > 0:
        ...
        print("   - Lexical analysis with comprehensive token support")
        ...
        if os.path.exists(output_dir):
            asm_files = [f for f in os.listdir(output_dir) if f.endswith('.asm')]        for asm_file in asm_files:
                print(f"   {asm_file}")
        print()
    
    print("C-like Compiler demonstration completed!")
    print("   The compiler supports C language features")
    print("   with a modular architecture suitable for")
    print("   educational purposes and further development.")

if __name__ == "__main__":
    demonstrate_compiler_features()
